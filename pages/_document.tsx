...
import {
  DEV, FA_TRACKING_ID, SENTRY_TRACKING_ID, SITE_DESCRIPTION, SITE_IMAGE, SITE_NAME,
  SITE_TITLE
...
fbq('track', 'PageView'); `
        ...
        <noscript>
          <img
            height="1"
            width="1"
            src={`//www.facebook.com/tr?id=${FA_TRACKING_ID}&ev=PageView&noscript=1`}
          />
        </noscript>
        }
        {!DEV &&
